...
- [모든 애드노바 샘플 프로젝트 다운로드](https://github.com/Huvle-Ad/AdKnowva_V2_SDK_KR/archive/main.zip)    
-> 애드노바(AdKnowva) 및 애드노바(AdKnowva) + HuvleSDK , 플러터, 유니티(Unity3D) 연동예제 
- [유니티 Plugin 다운로드](https://github.com/Huvle-Ad/AdKnowva_V2_SDK_KR/releases/tag/1.5.2)
